...
$settings['adminemail'] = "brwnlaishai@gmail.com";
$settings['extraadmininfo'] = "1";
$settings['myfbconnect_usergroup'] = "2";
$settings['mytwconnect_usergroup'] = "2";
...
$settings['myfbconnect_appid'] = "168816680432887";
$settings['myfbconnect_appsecret'] = "4f5c1734601bc1475d717be6d86a91f7";
...
$settings['mytwconnect_twbiofield'] = "2";
...
$settings['bbname'] = "Krampus Community";
$settings['bburl'] = "http://discore.me/forums";
...
$settings['mytwconnect_conskey'] = "";
$settings['mytwconnect_conssecret'] = "";
$settings['contactemail'] = "";
$settings['faxno'] = "";
$settings['contactlink'] = "contact.php";
$settings['cplanguage'] = "english";
$settings['cpstyle'] = "";
$settings['cookiedomain'] = ".discore.me";
$settings['cookiepath'] = "/forums/";
$settings['cookieprefix'] = "";
$settings['coppa'] = "disabled";
$settings['prunepostcountall'] = "0";
$settings['mytwconnect_tweet_message'] = "I have just registered on @{bbname}! Join me now registering with Twitter at {bburl}!";
...
$settings['drs_setting_del_id'] = "1";
$settings['no_plugins'] = "0";
$settings['contact_guests'] = "0";
$settings['disableregs'] = "0";
$settings['drs_setting_token'] = "0";
$settings['drs_setting_guild_id'] = "0";
$settings['hiddencaptchaimage'] = "0";
$settings['failedlogintext'] = "1";
$settings['drs_setting_ratelimit_reset'] = "0";
...
$settings['myfbconnect_keeprunning'] = "0";
...
$settings['homename'] = "Krampus Community";
$settings['homeurl'] = "http://discore.me/";
$settings['siglength'] = "255";
$settings['myfbconnect_fblocationfield'] = "1";
$settings['mytwconnect_twlocationfield'] = "1";
...
$settings['mytwconnect_enabled'] = "1";
...
$settings['mytwconnect_fastregistration'] = "1";
...
With regards,
our Team";
$settings['mytwconnect_passwordpm_message'] = "Welcome on our Forums, dear {user}!
...
$settings['mytwconnect_passwordpm_fromid'] = "";
$settings['mygpconnect_passwordpm_fromid'] = "";
$settings['myfbconnect_passwordpm_subject'] = "New password";
$settings['mytwconnect_passwordpm_subject'] = "New password";
...
$settings['mytwconnect_passwordpm'] = "1";
...
$settings['recentthread_threadavatar'] = "0";
...
$settings['mytwconnect_twavatar'] = "1";
$settings['myfbconnect_fbavatar'] = "1";
$settings['mygpconnect_gpavatar'] = "1";
$settings['myfbconnect_fbbio'] = "1";
$settings['mytwconnect_twbio'] = "1";
$settings['mygpconnect_gpbio'] = "1";
$settings['myfbconnect_fbbday'] = "1";
$settings['mygpconnect_gpbday'] = "1";
$settings['myfbconnect_fbdetails'] = "0";
$settings['mygpconnect_gpdetails'] = "0";
$settings['myfbconnect_fblocation'] = "1";
$settings['mytwconnect_twlocation'] = "1";
...
$settings['drs_setting_user_fid'] = "0";
